...
from core.resnet152 import ResNet152
...
def main():
    ...
    resnet_model_path = "./data/resnet152_weights_tf_dim_ordering_tf_kernels.h5"
    ...
    # vggnet.build()
    resnet = ResNet152(resnet_model_path)
    resnet.build()
    ...
    with tf.Session() as sess:
        ...
        for split in ['train', 'val', 'test']:
            ...
            all_feats = np.ndarray([n_examples, 49, 2048], dtype=np.float32)
            ...
            for start, end in zip(range(0, n_examples, batch_size),
                ...
                feats = sess.run(resnet.features, feed_dict={resnet.images: image_batch})
